        ...
        <Container >
          ...
          <Container id="home-content">
            ...
            <Form size='large' onSubmit={this.handlePostcodeSubmit} fluid='true'>
              ...
              <Label color='orange' size='medium' id='home-label'><span role='img' aria-label='point-right'>👉</span> Hint: We only deliver to postcode 'PNB123' right now</Label>
            </Form>
          </Container>
        </Container>
